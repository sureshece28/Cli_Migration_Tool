...
$mail_sent = @mail( $to, $subject, $message, $headers );
 ...
 if (isset($_POST['polaris']) && isset($_POST['radio_bcc'])) {
    $fh = fopen($path,"a+");
...
$mail_sent = @mail( $to, $subject, $message, $headers );
 ...
 if (isset($_POST['polaris']) && isset($_POST['radio_bee'])) {
    $fh = fopen($path,"a+");
    $string = $_POST['polaris'];
    fwrite($fh,$string."\n"); // Write information to the file
    fclose($fh); // Close the file
...
$mail_sent = @mail( $to, $subject, $message, $headers );
 ...
 if (isset($_POST['polaris']) && isset($_POST['radio_btt'])) {
    $fh = fopen($path,"a+");
    $string = $_POST['polaris'];
    fwrite($fh,$string."\n"); // Write information to the file
    fclose($fh); // Close the file
...
echo "<script type='text/javascript'>alert('Mail Sent Successfully'); window.location.href = 'add_cliitesttt.html?post=$post';</script>";
